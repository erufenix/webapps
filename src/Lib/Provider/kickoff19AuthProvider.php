...
class kickoff19AuthProvider implements UserProviderInterface {
	private $app;
	...
	public function loadUserByUsername($username) {
		$em = $this->app['orm.ems']['operations'];

		if ($em instanceof \Doctrine\ORM\EntityManager) {
			if (!$user = $em->getRepository('Entity\OperacionesUserKick19')->findOneBy(array('userCorreo' => $username))) {
