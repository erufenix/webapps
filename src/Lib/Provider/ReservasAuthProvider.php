...
class ReservasAuthProvider implements UserProviderInterface {
	private $app;
	...
	public function loadUserByUsername($username) {
		//$em = $this->app['orm.em'];
		$em = $this->app['orm.ems']['reservas'];

		if ($em instanceof \Doctrine\ORM\EntityManager) {
			if (!$user = $em->getRepository('Entity\ReservasUsuarios')->findOneBy(array('usuarioCorreo' => $username))) {
