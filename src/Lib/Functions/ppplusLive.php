...
class ppplusLive{
	...
	private function getToken(){
		$this->clientID = "AXIjt9ZwFU34lIzBOlOb2ozh5ZyQ3Tif7hehrFgyhcBFFTValGA4835roqraOvM_voonyy2ceGSfJ0r-";
		$this->secret 	= "EL-XIzcVqUMWNaZBThBH7yTVf2kkaKBSvN7wEV2pbYWZ34BTS4vtxzAZYA2EKzQQzxun4KvB-1Teyx9A";
		$response = array();
		$client = new Client([
		    'headers' => [ 
		...
		$response = $client->post('https://api.paypal.com/v1/oauth2/token',
		    [
	...
	private function getExpProfile($token,$params){
		...
		$response = $client->post('https://api.paypal.com/v1/payment-experience/web-profiles/',
		    [
